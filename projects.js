...
let flyers = document.getElementById("Flyer");
...
let SectionFlyers = document.getElementById("sectionFlyers");
...
flyers.addEventListener("click", (event)=>{
    event.preventDefault();
    ...
    sectionReponsive.classList.add("hidden");
    sectionGame.classList.add("hidden");
    SectionFlyers.classList.remove("hidden");

    todos.style.color = "#44566C";
    noReponsive.style.color = "#44566C";
    reponsive.style.color = "#44566C";
    game.style.color = "#44566C";
    flyers.style.color = "#0cb7f2";
